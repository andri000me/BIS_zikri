			...
			<div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
				<div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
					<span class="m-footer__copyright">
						<?php echo date('Y');?> &copy; SIMOCA by
						<a href="https://ksusb.co.id.com" class="m-link">
							KSPSB
						</a>
					</span>
				</div>
        ...
        var reg = JSON.parse(text);
            $("#gridcab").dxDataGrid({
                ...
                columns: [
                    ...
                    {dataField: 'status_kepemilikan', caption: 'Status Kepemilikan'},
...
loadTableGedung(null);
        $.ajax({
            type: 'POST',
            url: '../config/api.php?modul=ged&id=%',
            dataType: "json",
            success: function (data) {
...
function loadTableGedung(Data) {
            ...
            $("#gridgedung").dxDataGrid({
                ...
                columns: [
                    ...
                    {dataField: 'status_kepemilikan', caption: 'Status Kepemilikan',alignment:'center'},
                    ...
                    {dataField: 'nama_rm', caption: 'Nama RM',alignment:'center'},
                        ...
                        cellTemplate: function (container, options) {
                            if (options.rowType !== 'groupFooter') {
                                $('<div/>').html('<a a class="btn btn-danger"><span class ="label label-info">Send Email</span></a>')
                                    .appendTo(container);
                            }
														else{
                        ...
                        alignment: 'center', allowEditing: false
                    },
										{
												...
												cellTemplate: function (container, options) {
														if (options.rowType !== 'groupFooter') {
																$('<div/>').html('<a href="../action/sendEmail.php" class="btn btn-success"><span class ="label label-info">Unsent Email</span></a>')
																		.appendTo(container);
														}
														else{
